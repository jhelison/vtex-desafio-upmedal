  ...
  const renderForm = () => {
    return (
      <div style={{
        ...
        <h3 style={{color: 'white', textAlign: 'justify'}}>   Inscreva-se agora para receber as melhores promoções em seu email!</h3>
        {/* Form */}
        <div style={{display: 'flex', flexDirection: 'column', gap: '10px'}}>
          <label>Nome</label>
          <input style={{border: '1px solid #59ff00', borderRadius: '4px'}} placeholder="Nome"  
          value={name} onChange={handleNameChange}/>
          <label>Email</label>
          <input style={{border: '1px solid #59ff00', borderRadius: '4px'}} placeholder="Email" 
          value={email} onChange={handleEmailChange}/>
          <label>Telefone</label>
          <input style={{border: '1px solid #59ff00', borderRadius: '4px'}} placeholder="Telefone" 
          value={fone} onChange={handleFoneChange}/>
          {/* Subscribe button */}
          <button style={{
  ...
  const renderSubscribed = () => {
    return (
      <div style={{
        ...
        <h3 style={{textAlign: 'center'}}>Obrigado por se inscrever!</h3>
        <span style={{textAlign: 'center'}}>Essa janela se fechara automaticamente.</span>
      </div>
    )
  }
